...
qCompTree_4Ls1p.beta0_rad = qCompTree_4Ls1.beta0_rad;%interp1(qCompTree_4Ls1.t_paras, qCompTree_4Ls1.beta0_rad, ...
                                    %qCompTree_4Ls1p.t_paras);

%% s, len0
qCompTree_4Ls1p.s = qCompTree_4Ls1.s;%cumtrapz(qCompTree_4Ls1p.t_paras, sum(qCompTree_4Ls1p.q0.^2,1) );
