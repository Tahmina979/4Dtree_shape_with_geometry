...
qCompTree_3Ls1p.t_paras = qCompTree_3Ls1.t_paras;

qCompTree_3Ls1p.beta0_rad = qCompTree_3Ls1.beta0_rad;%interp1(qCompTree_3Ls1.t_paras, qCompTree_3Ls1.beta0_rad, ...
                                    %qCompTree_3Ls1p.t_paras);

%% s, len0
qCompTree_3Ls1p.s = qCompTree_3Ls1.s;%cumtrapz(qCompTree_3Ls1p.t_paras, sum(qCompTree_3Ls1p.q0.^2,1) );
