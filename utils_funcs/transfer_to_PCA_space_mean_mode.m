function [Mu,eigenVector, EVals,tree_pca,used_qCompTrees_Ready,qX,lambda]=transfer_to_PCA_space_mean_mode(ctree_1,ctree_2,ctree_5,ctree_6,ctree_7,ctree_10,num_within_seq1,num_within_seq2,num_within_seq5,num_within_seq6,num_within_seq7,num_within_seq10)
lam_m = 1; 
lam_s = 1;
lam_p = 1;
...
for i=p:p_end
  used_qCompTrees{i}=ctree_10.aligned_q_tree_10{i-p+1};
end
